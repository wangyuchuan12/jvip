...
public class TbaseGradeConfigService extends BaseAbstractService<TbaseGradeConfig> {
    ...
    public TbaseGradeConfig getMaxByIntegral(Long integral){
        ...
        sb.append("select levelconfig_id as id,levelconfig_integral as integral,levelconfig_grade grade from tbase_grade_config where levelconfig_integral<="+integral+" order by levelconfig_integral desc");
